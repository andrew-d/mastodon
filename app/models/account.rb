...
class Account < ApplicationRecord
  ...
  LOCAL_USERNAME_ONLY_RE = /\A[a-z0-9_]+\z/i
  ...
  validates :username, format: { with: LOCAL_USERNAME_ONLY_RE }, length: { maximum: 30 }, if: -> { local? && will_save_change_to_username? && actor_type != 'Application' }
